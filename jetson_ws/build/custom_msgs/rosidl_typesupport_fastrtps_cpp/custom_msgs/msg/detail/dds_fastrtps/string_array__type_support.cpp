...
#include "custom_msgs/msg/detail/string_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const custom_msgs::msg::Detections &,
...
cdr_serialize(
  const custom_msgs::msg::StringArray & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_msgs::msg::StringArray & ros_message)
{
  // Member: detections
  {
    uint32_t cdrSize;
  ...
  size_t current_alignment)
{
  ...
  // Member: detections
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        custom_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Detections(
...
{
  auto typed_message =
    static_cast<const custom_msgs::msg::StringArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_msgs::msg::StringArray *>(
    untyped_ros_message);
...
{
  return &custom_msgs::msg::typesupport_fastrtps_cpp::_StringArray__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_msgs, msg, StringArray)() {
  return &custom_msgs::msg::typesupport_fastrtps_cpp::_StringArray__handle;
}
